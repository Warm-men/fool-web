...
const wxLogin = (reConnect, redirect_uri = defaultRedirectUrl) => {
  ...
  const url = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${global.appid}&redirect_uri=${redirect_uri}&response_type=code&scope=snsapi_userinfo&state=STATE&connect_redirect=1#wechat_redirect`
